...
# Only used when state_is_tuple=True.
        ...
        net = tflearn.regression(real_output_sequence, optimizer='adam', learning_rate=0.000001, loss='mean_square')
    ...
    def train(self):
        ...
        model.fit(trainXY, trainY, n_epoch=100000, snapshot_epoch=False, batch_size=1999)
